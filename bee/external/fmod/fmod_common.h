...
*/
typedef FMOD_RESULT(
    F_CALL *FMOD_DEBUG_CALLBACK)(FMOD_DEBUG_FLAGS flags, const char *file, int line, const char *func, const char *message);
...
typedef FMOD_RESULT(F_CALL *FMOD_SOUND_PCMSETPOS_CALLBACK)(FMOD_SOUND *sound,
                                                           int subsound,
...
typedef FMOD_RESULT(F_CALL *FMOD_FILE_READ_CALLBACK)(void *handle,
                                                     void *buffer,
...
typedef void *(F_CALL *FMOD_MEMORY_REALLOC_CALLBACK)(void *ptr,
                                                     unsigned int size,
