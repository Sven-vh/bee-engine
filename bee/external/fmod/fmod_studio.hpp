...
public:
    ...
    FMOD_RESULT F_API initialize(int maxchannels,
    ...
    FMOD_RESULT F_API getParameterDescriptionByID(FMOD_STUDIO_PARAMETER_ID id,
    ...
    FMOD_RESULT F_API
    getParameterLabelByID(FMOD_STUDIO_PARAMETER_ID id, int labelindex, char *label, int size, int *retrieved) const;
    ...
    FMOD_RESULT F_API setParametersByIDs(const FMOD_STUDIO_PARAMETER_ID *ids,
                                         float *values,
                                         int count,
    ...
    FMOD_RESULT F_API getListenerAttributes(int listener,
    ...
    FMOD_RESULT F_API loadBankMemory(const char *buffer,
                                     int length,
